      ...
      <main className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            <li><strong>Personal identifiers:</strong> such as name, email address, username, and other similar identifiers.</li>
            <li><strong>Account information:</strong> including login credentials, profile information, and preferences.</li>
            <li><strong>Usage data:</strong> information about how you use our website and Services.</li>
            <li><strong>Device information:</strong> such as IP address, browser type, operating system, and other technology on the devices you use to access our Services.</li>
          </ul>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            <li><strong>With service providers:</strong> We may share your information with third-party vendors, service providers, and other parties who perform services on our behalf.</li>
            <li><strong>With business partners:</strong> We may share your information with our business partners to offer you certain products, services or promotions.</li>
            <li><strong>When required by law:</strong> We may disclose your information where required to do so by law or subpoena.</li>
